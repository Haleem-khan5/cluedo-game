    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-3xl text-cream mt-4">Join the Investigation</h1>
          <p className="text-cream/60 mt-2">Create your detective account</p>
        </div>
        ...
        <div className="rounded-2xl bg-mansion-card border border-cream/10 p-6 space-y-6 shadow-2xl">
          ...
          <Button variant="ghost" className="w-full" onClick={handleGoogle} type="button">
